...
function generarContenido($datos) {
	...
	// función galeria.
	// $content .= generarGaleria($datos);
	$content .= generarGaleriaJetpack($datos);
...
/**
 * Crear función para generar galeria simple.
 */
function generarGaleria($datos) {
	$content = '';
...
// crear función para generar etiquetas.


/**
 * Crear función para generar galeria jetpack.
 */
function generarGaleriaJetpack($datos) {
